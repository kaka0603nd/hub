                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <ul>
                                        <li><span>Tên đăng nhập : </span> <strong><?php echo $name?> </strong></li>
                                        <li><span>Email đăng nhập : </span> <strong><?php echo $email?> </strong></li>
                                        <li><span>Tên gian hàng : </span> <strong><?php echo $name_store?> </strong></li>
                                        <li><span>Địa chỉ : </span> <strong><?php echo $diachi?> </strong></li>
                                        
                                        <li><span>Tỉnh : </span> <strong><?php echo $tinhthanh?> </strong></li>
                                        <li><span>Số chứng minh : </span> <strong><?php echo $sochungminh?> </strong></li>
                                        <li><span>Số điện thoại : </span> <strong><?php echo $sodienthoai?> </strong></li>
                                        <li><span>WebSite : </span> <strong><?php echo $website?> </strong></li>
                                        <li><span>Ảnh / Logo : </span><strong><?php echo $hinhanh?> </strong></li>
                                    </ul>
