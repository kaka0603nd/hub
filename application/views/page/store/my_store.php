...
<div class="container">
    ...
    <section class="row" style="margin-top: 24px;">
        <div class="col-md-8">
            <h2 class="title-block"><?php echo $sanpham[0]['name_store']?></h2>
            <div class="sanpham">
                <div class="row">
                        <?php
                        if(count($sanpham) ==0){
                                            echo '<div style="height: 298px;"><h3>SORRY</h3><p>Không tìm thấy sản phẩm nào ...</p></div>';
                                        }
                                        else{
                                           
                                        foreach($sanpham as $row){
                                        $img = $row['sanpham_hinhanh'];
                                        if(empty($img)){
                                            $img = 'image_null.png';
                                        }
                                        else{
                        ...
                        <div class="col-md-4">
                            <div class="box-sanpham">
                                <div>
                                                <a title="<?php echo $row['tensanpham']?>" href="<?php echo base_url();?>home/sanpham/<?php echo $row['sanpham_id']?>">
                                            ...
                                            <div class="product-info">
                                                <h6>
                                                    <a href="<?php echo base_url();?>home/sanpham/<?php echo $row['sanpham_id']?>"><?php echo $row['tensanpham']?></a>
                                                </h6>
                                                <div class="priceInfo">
                                            ...
                                            <div class="show_control">
                                                ...
                                                <a class="btn btn-default btn_giohang" href="<?php echo base_url();?>giohang/add_cart/<?php echo $row['sanpham_id']?>"><input type="hidden" class="input_id" value="<?php echo $row['sanpham_id']?>"/><img src="<?php echo base_url();?>public/images/icon/cart.png" /> Giỏ hàng</a>
                                            </div>
                            </div>
                        </div>
                        <?php
