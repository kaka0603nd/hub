        ...
        <table class="table table-bordered" id="table_thongtingianhang">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="<?php echo base_url().'/admin/store/'.$row['id']?>"><?php echo $row['name']?></a></td>
                    ...
                    <td><span><?php 
                                ...
                                ?></span></td>
                    <td><a class="btn btn-success" href="<?php echo base_url();?>admin/store/form_edit/<?php echo $row['id']?>"><img src="<?php echo base_url();?>public/images/hp-icon-approval-workflow.png" width="16px"/></a><a class="btn btn-warning" href="<?php echo base_url();?>admin/store/action_delete/<?php echo $row['id']?>"><img src="<?php echo base_url();?>public/images/trash_mail.gif"/></td>
                </tr>
            <?php
                }
            ?>
